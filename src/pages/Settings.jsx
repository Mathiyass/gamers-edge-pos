...
export default function Settings() {
  ...
  return (
    <motion.div
      ...
      className="h-full p-8 max-w-6xl mx-auto flex flex-col overflow-y-auto custom-scrollbar relative bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-[#0a0a0a] to-black"
    >
      ...
      <div className="mb-8 z-10 shrink-0">
        ...
        <p className="text-slate-400 mt-1 font-medium text-sm flex items-center gap-2 max-w-2xl">
          ...
          <Card>
            ...
            <form onSubmit={handleSaveSettings} className="space-y-6">
              ...
              <div className="flex justify-end pt-4 border-t border-slate-800">
                <Button type="submit" variant="primary" className="shadow-lg shadow-cyan-900/20 hover:shadow-[0_0_15px_rgba(6,182,212,0.4)] transition-all duration-300">
