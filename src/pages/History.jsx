...
export default function History() {
    ...
    return (
        <motion.div
            ...
            className="h-full flex flex-col space-y-6 overflow-hidden relative bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-[#0a0a0a] to-black"
        >
            ...
            {/* Header */}
            <div className="flex justify-between items-center bg-slate-900/50 p-6 rounded-2xl border border-slate-800 backdrop-blur-sm relative z-10">
                <div>
