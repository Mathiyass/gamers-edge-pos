...
export default function Repairs() {
  ...
  return (
    <motion.div
      ...
      className="h-full p-6 flex flex-col overflow-hidden relative bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-[#0a0a0a] to-black"
    >
                ...
                <AnimatePresence>
                  {items.map(ticket => (
                    <motion.div
                      ...
                      className="bg-slate-900/40 backdrop-blur-md border border-slate-800 shadow-2xl p-4 rounded-xl hover:shadow-[0_0_15px_rgba(6,182,212,0.4)] transition-all duration-300 group relative cursor-default"
                    >
